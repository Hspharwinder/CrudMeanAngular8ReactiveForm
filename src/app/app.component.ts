...
export class AppComponent implements OnInit {
  ...
  // property of gamesCheckBoxList it would be call each time on checkbox change 
  get checkList(){
  ...
  onSubmit(form :any){
    ...
    if(this.otherTextBox && this.otherGames){
        ...
        delete this.formValue.value.otherGames; // no need of otherGames property
        console.log({...this.formValue.value, games});     
    }
    else{
      delete this.formValue.value.games; // if games property empty delete it
      delete this.formValue.value.otherGames;
      console.log({...this.formValue.value,games});
    }
  }
